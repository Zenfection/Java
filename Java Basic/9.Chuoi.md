...
| Phương thức                                            | Mô tả                                   | Trả về  | Ví dụ                                                 |
| ------------------------------------------------------ | --------------------------------------- | ------- | ----------------------------------------------------- |
| charAt()<br>                                           | trả về **chữ cái** được chỉ định vị trí | char    | `myName` = `"Lê Tuấn Kiệt"`<br>`myName.charAt[1]` ⇨ ê |
| codePointAt()<br>codePointBefore()<br>codePointCount() |                                         | int     |                                                       |
