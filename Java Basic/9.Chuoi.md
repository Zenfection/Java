...
| concat(x)                                            | nối 2 chuỗi                                                                                                                   | String                                               | `myName.concat("World")` ⇨ Hello World                                                                                                                                                         |                                                                                                                                                                                                                                                        |
| contains(x)<br>contentEquals(x)                      | kiểm tra chuỗi có chứa ký tự **x**<br>kiểm tra chuỗi chứa *chuỗi* **x**                                                       | boolean                                              | `myName.contains("el")` ⇨ true<br><br>`myName.contentEquals("el")` ⇨ false<br>`myName.contentEquals("Hello")` ⇨ true<br><br>`myName.endsWith("He")` ⇨ false<br>`myName.endsWith("llo")` ⇨ true |                                                                                                                                                                                                                                                        |
| startsWith(x)<br>endsWith(x)                         | kiểm rta chuỗi **bắt đầu** bằng chuỗi **x**<br>kiểm tra chuỗi bắt đầu bằng chuỗi **x**                                        | boolean                                              | `myName.startsWith("He")` ⇨ true<br>`myName.startsWith("llo")` ⇨ false<br><br>`myName.endsWith("He")` ⇨ false<br>`myName.endsWith("llo")` ⇨ true                                               |                                                                                                                                                                                                                                                        |
| copyValueOf                                          |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| fomat()                                              |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| getBytes()                                           |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| getChars()                                           |                                                                                                                               | int                                                  |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| hashCode(x)                                          | trả về **bãng băm** của chuỗi **x**                                                                                           | int                                                  | `myName.hashCode()` ⇨ 69609650                                                                                                                                                                 | 💡 Tìm hiểu bảng băm [tại đây](https://vimentor.com/vi/lesson/ba-ng-bam-hash-table)                                                                                                                                                                    |
| indexOf(x)<br>lastIndexOf(x)                         | trả về vị trí ký tự xuất hiện **đầu tiên** trong chuỗi **x**<br>trả về vị trí ký tự xuất hiện **cuồi cùng** trong chuỗi **x** | int                                                  | `myname.indexOf("l")` ⇨ 2 <br>`myname.lastIndexOf("l")`  ⇨ 3                                                                                                                                   |                                                                                                                                                                                                                                                        |
| intern()                                             |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| isEmpty()<br>isBlank()                               | kiểm tra chuỗi rỗng                                                                                                           | boolean                                              | `myName.isEmpty()`  ⇨ false<br>`"".isEmpty` ⇨ true<br><br>`"   ".isBlank()` ⇨ true                                                                                                             | ⚠️ `isBlank` kiểm tra chuỗi rỗng không tính *khoảng trắng*                                                                                                                                                                                             |
| length(x)                                            | trả về độ dài chuỗi                                                                                                           | int                                                  | `myName.length()` ⇨ 5                                                                                                                                                                          |                                                                                                                                                                                                                                                        |
| matches()                                            |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| offsetByCodePoints()                                 |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| regionMatches()                                      |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| replace(x,y)<br>replaceFirst(x,y)<br>replaceAll(x,y) | trả về chuỗi mới  **x** thay bằng **y**                                                                                       | String                                               | `myName.replace('l','p')` ⇨ Heppo<br>`myName.replaceFirst("l","paa")`  ⇨ Heppalo<br>`myName.replaceAll("llo","ppa")` ⇨ Heppa                                                                   | ⚠️ Đối số của`replace` là ký tự.<br>⚠️ Đối số của `replaceFirst` và `replaceAll` là chuỗi<br>⚠️  `replaceFirst` chỉ thay đổi chuỗi **x** đầu tiên.                                                                                                     |
| split(x)                                             | Chuyển **chuỗi** thành **mảng chuỗi** bằng nhận biết x                                                                        | String[]                                             | `String [] ArrayName = myName.split("")` ⇨ ArrayName ={"H","e","l","l","o"}                                                                                                                    | 💡 Bạn có thể thay thế chuỗi **x**, làm điểm tách chuỗi                                                                                                                                                                                                |
| subSequence(a,b)<br>subString(a,b)                   | Trả về chuỗi mới lấy từ chuỗi gốc vị trí *a tới b*                                                                            | CharSequence (*subSequence*)<br>String (*subString*) | `CharSequence word = myName.subSequence(0,2)` ⇨ word = "He"<br>`String word = myName.subString(0,2)` ⇨ word = "He"                                                                             | 🤔 Sự khác biệt giữa `String` và `CharSquence` [tại đây](https://www.it-swarm-vi.com/vi/java/su-khac-biet-chinh-xac-giua-charsequence-va-string-trong-java/1068529714/#:~:text=CharSequence%20là%20một%20chuỗi%20các,trình%20tự%20char%20khác%20nhau.) |
| subString()                                          |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
| toCharArray()                                        |                                                                                                                               |                                                      |                                                                                                                                                                                                |                                                                                                                                                                                                                                                        |
