...
| codePointAt(*p*)<br>codePointBefore(*p*)             | trả về số bảng mã `Unicode`                                                                                                   | int          | `Name.codePointAt(0)` <br>⇨ 72<br>`Name.codePointAt(1)` <br>⇨ 72<br>                                                                                                                                    | ⚠️ `codePointAt` bắt đầu bằng *0*<br>⚠️ `codePointBefore` bắt đầu bằng *1*                                                                                                                                                                             |
...
| matches(x)                                           | tìm kiếm theo biểu thức chính quy                                                                                             | boolean      | `Name.matches("He(.*)")`<br>⇨ true                                                                                                                                                                      | 💡 Tìm hiểu biểu thức chính quy [tại đây](https://www.google.com/search?q=regular+expression&oq=regular+expression&aqs=chrome..69i57j69i60&sourceid=chrome&ie=UTF-8)                                                                                   |
...
| contains(x)<br>contentEquals(x)                      | kiểm tra chuỗi có chứa ký tự **x**<br>kiểm tra chuỗi chứa *chuỗi* **x**                                                       | boolean      | `Name.contains("el")`<br>⇨ true<br><br>`Name.contentEquals("el")`<br> ⇨ false<br>`Name.contentEquals("Hello")`<br> ⇨ true<br><br>`Name.endsWith("He")`<br> ⇨ false<br>`Name.endsWith("llo")`<br> ⇨ true |                                                                                                                                                                                                                                                        |
...
| hashCode(x)                                          | trả về **bãng băm** của chuỗi **x**                                                                                           | int          | `Name.hashCode()`<br> ⇨ 69609650                                                                                                                                                                        | 💡 Tìm hiểu bảng băm [tại đây](https://vimentor.com/vi/lesson/ba-ng-bam-hash-table)                                                                                                                                                                    |
